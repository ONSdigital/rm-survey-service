...
func bootstrapSQL() [18]string {
	sql := [18]string{
		...
		"INSERT INTO survey (surveypk, id, shortname, longname, surveyref) VALUES (1, 'cb0711c3-0ac8-41d3-ae0e-567e5ea1ef87', 'BRES', 'Business Register and Employment Survey', '221');",
