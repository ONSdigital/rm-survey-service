...
func main() {
	...
	r.HandleFunc("/surveys/ref/{surveyRef}/shortname/{shortName}", use(api.PutSurveyShortName, basicAuth)).Methods("PUT")
	r.HandleFunc("/surveys/ref/{surveyRef}/longname/{longName}", use(api.PutSurveyLongName, basicAuth)).Methods("PUT")
